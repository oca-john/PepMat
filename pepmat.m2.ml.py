...
# 选择并训练模型 - SVC 分类模型
model_m2_cls = SVC()
model_m2_cls.fit(train_dat, train_cls)
# 保存模型
joblib.dump(model_m2_cls, 'models-saved/model_m2_cls.pkl')
# 测试模型
...
model_m2_reg = MultiOutputRegressor(tree)
# 训练
model_m2_reg.fit(train_dat, train_val)
# 保存模型
joblib.dump(model_m2_reg, 'models-saved/model_m2_reg.pkl')
# 预测
y_pred = model_m2_reg.predict(test_dat)
# 评估
r2 = r2_score(test_val, y_pred).round(4)
