...
# 读入生成时同步分配的标签
val_folder_path = 'dataset-60h/tags'
...
# 加载模型
model_m4_cls = tf.keras.models.load_model('models-saved/model_m4_cls')
...
# 加载模型
model_m4_reg = tf.keras.models.load_model('models-saved/model_m4_reg')
